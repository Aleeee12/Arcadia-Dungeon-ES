...
public class DungeonConfig {
    ...
    public String startMessage = "&6[Dungeon] &e%player% &7is launching &e%dungeon%&7! Join with &f/arcadia_dungeon join %id%&7!";
    public String completionMessage = "&6[Dungeon] &a%player% &7has defeated &e%dungeon%&7!";
    public String failMessage = "&6[Dungeon] &c%player% &7a fails in &e%dungeon%&7!";
    ...
    public String availabilityMessage = "&6[Dungeon] &e%dungeon% &7is available again! &fStart it with &e/arcadia_dungeon start %id%";
    ...
    public String recruitmentMessage = "&6[Dungeon] &e%player% &7is opening &e%dungeon%&7! &fJoin in %time%s &7with &f/arcadia_dungeon join %id%";
